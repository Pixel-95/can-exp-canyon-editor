import type { TrackBindings, TrackSnapshot } from "../RouteMapApp";
...
export function buildTrackBindings(
  canyonData: JsonObject | null,
...
export function withSectionTourDimensionsFromTracks(
  canyonData: JsonObject,
