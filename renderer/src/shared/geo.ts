...
export function parseCoordinateInput(rawValue: string): { coordinate: Coordinate | null; error: string } {
...
export function appendCoordinate(target: Coordinate[], candidate: Coordinate): void {
...
export function appendCoordinates(target: Coordinate[], candidates: Coordinate[]): void {
...
export function calculateStraightSegmentDurationSeconds(distanceM: number, deltaElevationM: number): number {
...
export function toCoordinatePair(value: unknown): Coordinate | null {
...
export function toCoordinatesArray(value: unknown): Coordinate[] {
